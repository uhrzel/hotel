...
">
    ...
    <table class="table table-striped table-bordered table-responsive text-center" width="100%">
        ...
        <tbody>
            <?php
            $book_query = "SELECT * FROM booking bk LEFT JOIN customer ct ON bk.customer_id=ct.customer_id LEFT JOIN room rm ON bk.room_id=rm.room_id WHERE bk.payment_status = '1' AND YEAR(bk.booking_date) = '$selectedYear' AND MONTH(bk.booking_date) = '$selectedMonth'";
