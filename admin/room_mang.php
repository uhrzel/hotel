<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    $countCheckOutEraly = 0;

    $book_query = "SELECT * FROM booking bk LEFT JOIN customer ct ON bk.customer_id=ct.customer_id LEFT JOIN room rm ON bk.room_id=rm.room_id WHERE rm.deleteStatus=0";
    ...
    if (mysqli_num_rows($books_result) > 0) {
        while ($booksList = mysqli_fetch_assoc($books_result)) {
            ...
            $year = date('Y', strtotime($booksList['check_out']));
            $month = date('m', strtotime($booksList['check_out']));
            $day = date('d', strtotime($booksList['check_out']));
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">Manage Rooms
                    <button class="btn btn-secondary pull-right" style="border-radius:0%; margin-left: 20px;" data-toggle="modal" data-target="#addRoom">Add Rooms</button>

                    <button class="btn btn-primary pull-right" style="border-radius:0%;" data-toggle="modal" data-target="#showListCehckOut">View CheckOut <span class="text-white" style="
                    font-size: 18px;
                    background: #FFC107;
                    padding: 10px 10px;
                    border-radius: 50%;
                    ...
                    right: 140px;
                    width: 45px;
                "><?= $countCheckOutEraly ?></span></button>
                                ...
                                while ($rooms = mysqli_fetch_assoc($rooms_result)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button title="Edit Room Information" style="border-radius:60px;" data-toggle="modal" data-target="#editRoom" data-id="<?php echo $rooms['room_id']; ?>" id="roomEdit" class="btn btn-info"><i class="fa fa-pencil"></i></button>
                                            <?php
                                            if ($rooms['status'] == 1) {
                        ...
                        <div class="col-lg-12">
                            <table class="table table-responsive table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><select id="payment_mode" name="payment_mode">
                            ...
                            <form role="form" id="advancePayment">
                                ...
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="number" class="form-control" id="advance_payment" placeholder="Please Enter Amounts Here..">
                                </div>
    ...
    <div id="showListCehckOut" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title text-center"><b>Check Out List</b></h4>
                </div>
                <div class="modal-body">
                    <table class="table table-striped table-bordered table-responsive text-center" cellspacing="0" width="100%">
                        <tr>
                            <th>Customer Name</th>
                            <th>Card No.</th>
                            <th>Room No</th>
                            ...
                            while ($booksList = mysqli_fetch_assoc($books_result)) {
                                ...
                                if ($year == $currentYear && $month == $currentMonth && $day > $currentDay) {
                                    ...
                                    <tr>
                                        ...
                                        <td class='text-danger'>$booksList[check_out]</td>
                                    </tr>
                                ";
                                }
                            }
