...
<body>
    ...
    <div class="container mt-5">
        <h2 class="text-center">Yearly Sales Report</h2>
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $sql = "SELECT SUM(total_price) AS total_sales FROM booking WHERE payment_status = '1' AND YEAR(booking_date) = '$selectedYear'";
            $amountsum = mysqli_query($connection, $sql) or die(mysqli_error($connection));
            $row_amountsum = mysqli_fetch_assoc($amountsum);

            echo "<p class='lead text-center'>Total Sales for $selectedYear: " . $row_amountsum['total_sales'] . ".00" . "</p>";

            include 'year_list_data.php';
        }
        ?>
